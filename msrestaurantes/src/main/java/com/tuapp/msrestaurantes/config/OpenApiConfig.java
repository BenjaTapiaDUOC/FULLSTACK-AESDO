package com.tuapp.msrestaurantes.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("MS Restaurantes API")
                        .description("Microservicio encargado de la gestión de restaurantes y su estado (activo/inactivo).")
                        .version("1.0.0")
                        .contact(new Contact()
